...
- Glasgow International Scholarships: HTTP 404
...
- Westlake Scholarships: error sending request for url (https://www.westlake.edu.cn/scholarships/): error trying to connect: dns error: failed to lookup address information: Temporary failure in name resolution
...
- Alpha Lambda Delta Scholarships: error sending request for url (https://www.alphalambdadelta.org/scholarships): error trying to connect: Connection reset by peer (os error 104)
...
- Omega Psi Phi Scholarships: error sending request for url (https://www.omegapsiphifraternity.org/scholarships): operation timed out
