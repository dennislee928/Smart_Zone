...
POST Request
    ...
    ...    ELSE    POST Request With Error Handling    ${url}    json_data=${EMPTY}    headers=${final_headers}    timeout=${API_TIMEOUT}
    RETURN    ${response}
...
PUT Request
    ...
    ...    ELSE    PUT Request With Error Handling    ${url}    json_data=${EMPTY}    headers=${final_headers}    timeout=${API_TIMEOUT}
    RETURN    ${response}
